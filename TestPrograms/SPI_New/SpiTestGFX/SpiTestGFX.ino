...
#include <Adafruit_GFX_SE.h>    // Core graphics library
#include "Adafruit_ST7735_SE.h" // Hardware-specific library for ST7735
//#include <Adafruit_ST7789_2.h> // Hardware-specific library for ST7789
#include <SPI.h>
...
void setup(void) {
  ...
  tft.setSPISpeed(80000000);//40mHZ
