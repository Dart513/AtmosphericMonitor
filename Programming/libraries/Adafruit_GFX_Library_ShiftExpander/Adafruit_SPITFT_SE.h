...
#else  // !USE_FAST_PINIO
    ShiftExpander::digitalWriteExpanded(_cs, HIGH);
...
#endif // end !HAS_PORT_SET_CLR
#else  // !USE_FAST_PINIO
    ShiftExpander::digitalWriteExpanded(_cs, LOW);
#endif // end !USE_FAST_PINIO
  }
...
#endif // end !HAS_PORT_SET_CLR
#else  // !USE_FAST_PINIO
    ShiftExpander::digitalWriteExpanded(_dc, HIGH);
#endif // end !USE_FAST_PINIO
  }
...
#endif // end !HAS_PORT_SET_CLR
#else  // !USE_FAST_PINIO
    ShiftExpander::digitalWriteExpanded(_dc, LOW);
#endif // end !USE_FAST_PINIO
  }
